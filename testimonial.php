  ...
  <div class="container">
    <div class="col-md-8 col-md-offset-2 text-center">
       <?php 
                    ...
                    ?>
                    <h6>TESTIMONIAL</h6>
                     <p>Bagaimana pengalaman & pendapat mereka yang telah menjadi warga dan senantiasa menggunakan layanan dari kami ? Biarlah masyarakat kami yang berbicara & berbagi cerita dengan Anda</p>
                    <br>
                    </li>
                    <?php }else{?>
                    <h6>TESTIMONIAL</h6>
