...
<section  class="section intro">
  <h6 align="center">Ubah Gambar Galeri</h6>
  <br><br>
      ...
      <div class="col-md-12">
        <div class="form-group">            
            ...
            <label>Nama Tempat Wisata</label>
                <input class="form-control" type="text" name="nama_tempat" id="nama_tempat" value="<?php echo $data['nama_tempat']; ?>" required>
            <br>
            ...
            <label></label>
            <br><br>
          <button class="btn btn-block btn-info" value="Ubah" type="submit" >Ubah Data</button>
        </div>
      </div>
    </div>
